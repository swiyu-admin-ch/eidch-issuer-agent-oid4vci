...
@AnalyzeClasses(
        packagesOf = {Oid4vciApplication.class},
...
public class ArchitectureTest {
    ...
    public static class ArchitectureRules {
         ...
         */
        // Temporary Disable. It does not work correctly as it still allows some access
        // According to https://marcoatschaefer.medium.com/onion-architecture-explained-building-maintainable-software-54996ff8e464
        // it is debatable if it makes sense to have
//        @ArchTest
