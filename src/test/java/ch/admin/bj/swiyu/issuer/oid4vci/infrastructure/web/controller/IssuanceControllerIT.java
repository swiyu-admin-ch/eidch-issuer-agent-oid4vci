...
class IssuanceControllerIT {
    ...
    void setUp() throws JOSEException {
        ...
        saveStatusListLinkedOffer(createTestOffer(allValuesOfferId, allValuesPreAuthCode, CredentialStatus.OFFERED, "university_example_sd_jwt", validFrom, validUntil), statusList);
